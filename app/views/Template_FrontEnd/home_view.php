    ...
    <div id="main-slide" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="item active">
                <img class="img-responsive" src="<?php echo SITE_URL_FIMAGES; ?>/slider/bg1.jpg" alt="slider">
            ...
            <!--/ Carousel item end -->
            <div class="item">
                <img class="img-responsive" src="<?php echo SITE_URL_FIMAGES; ?>/slider/bg2.jpg" alt="slider">
                    <div class="slider-content">
                        <div class="col-md-12 text-center">
                            <h2 class="animated4">
            ...
            <!--/ Carousel item end -->
            <div class="item">
                <img class="img-responsive" src="<?php echo SITE_URL_FIMAGES; ?>/slider/bg3.jpg" alt="slider">
                    <div class="slider-content">
                        <div class="col-md-12 text-center">
...
<div class="section full-width-portfolio" style="border-top:0; border-bottom:0; background:#fff;">
    ...
    <ul id="portfolio-list" data-animated="fadeIn">
        <li>
            <img src="<?php echo SITE_URL_FIMAGES; ?>/portfolio-1/1.png" alt="" />
        ...
        <li>
            <img src="<?php echo SITE_URL_FIMAGES; ?>/portfolio-1/2.png" alt="" />
            <div class="portfolio-item-content">
        ...
        <li>
            <img src="<?php echo SITE_URL_FIMAGES; ?>/portfolio-1/3.png" alt="" />
            <div class="portfolio-item-content">
        ...
        <li>
            <img src="<?php echo SITE_URL_FIMAGES; ?>/portfolio-1/4.png" alt="" />
            <div class="portfolio-item-content">
        ...
        <li>
            <img src="<?php echo SITE_URL_FIMAGES; ?>/portfolio-1/5.png" alt="" />
            <div class="portfolio-item-content">
        ...
        <li>
            <img src="<?php echo SITE_URL_FIMAGES; ?>/portfolio-1/6.png" alt="" />
            <div class="portfolio-item-content">
        ...
        <li>
            <img src="<?php echo SITE_URL_FIMAGES; ?>/portfolio-1/7.png" alt="" />
            <div class="portfolio-item-content">
                <span class="header">Monocle issue 69</span>
                <p class="body">web develpment, design</p>
            </div>
        ...
        <li>
            <img src="<?php echo SITE_URL_FIMAGES; ?>/portfolio-1/8.png" alt="" />
            <div class="portfolio-item-content">
                <span class="header">Monocle issue 69</span>
                <p class="body">web develpment, design</p>
            </div>
        ...
        <li>
            <img src="<?php echo SITE_URL_FIMAGES; ?>/portfolio-1/9.png" alt="" />
            <div class="portfolio-item-content">
                <span class="header">Monocle issue 69</span>
                <p class="body">web develpment, design</p>
            </div>
        ...
        <li>
            <img src="<?php echo SITE_URL_FIMAGES; ?>/portfolio-1/10.png" alt="" />
            <div class="portfolio-item-content">
                <span class="header">Monocle issue 69</span>
                <p class="body">web develpment, design</p>
            </div>
        ...
        <li>
            <img src="<?php echo SITE_URL_FIMAGES; ?>/portfolio-1/11.png" alt="" />
            <div class="portfolio-item-content">
                <span class="header">Monocle issue 69</span>
                <p class="body">web develpment, design</p>
            </div>
        ...
        <li>
            <img src="<?php echo SITE_URL_FIMAGES; ?>/portfolio-1/12.png" alt="" />
            <div class="portfolio-item-content">
                <span class="header">Monocle issue 69</span>
                <p class="body">web develpment, design</p>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12" data-animation="fadeIn" data-animation-delay="03">
                <div class="team-member modern">
                    ...
                    <div class="member-photo">
                        <img alt="" src="<?php echo SITE_URL_FIMAGES; ?>/team/face_1.png" />
            ...
            <div class="col-md-3 col-sm-6 col-xs-12" data-animation="fadeIn" data-animation-delay="04">
                <div class="team-member modern">
                    <!-- Memebr Photo, Name & Position -->
                    <div class="member-photo">
                        <img alt="" src="<?php echo SITE_URL_FIMAGES; ?>/team/face_2.png" />
            ...
            <div class="col-md-3 col-sm-6 col-xs-12" data-animation="fadeIn" data-animation-delay="05">
                <div class="team-member modern">
                    <!-- Memebr Photo, Name & Position -->
                    <div class="member-photo">
                        <img alt="" src="<?php echo SITE_URL_FIMAGES; ?>/team/face_3.png" />
            ...
            <div class="col-md-3 col-sm-6 col-xs-12" data-animation="fadeIn" data-animation-delay="06">
                <div class="team-member modern">
                    <!-- Memebr Photo, Name & Position -->
                    <div class="member-photo">
                        <img alt="" src="<?php echo SITE_URL_FIMAGES; ?>/team/face_4.png" />
...
<div id="parallax-one" class="parallax" style="background-image:url(<?php echo SITE_URL_FIMAGES; ?>/parallax/bg-02.jpg);">
            ...
            <div class="our-clients">
                <div class="clients-carousel custom-carousel touch-carousel navigation-3" data-appeared-items="5" data-navigation="true">
                    ...
                    <div class="client-item item">
                        <a href="#"><img src="<?php echo SITE_URL_FIMAGES; ?>/c1.png" alt="" /></a>
                    </div>

                    <!-- Client 2 -->
                    <div class="client-item item">
                        <a href="#"><img src="<?php echo SITE_URL_FIMAGES; ?>/c2.png" alt="" /></a>
                    </div>

                    <!-- Client 3 -->
                    <div class="client-item item">
                        <a href="#"><img src="<?php echo SITE_URL_FIMAGES; ?>/c3.png" alt="" /></a>
                    </div>

                    <!-- Client 4 -->
                    <div class="client-item item">
                        <a href="#"><img src="<?php echo SITE_URL_FIMAGES; ?>/c4.png" alt="" /></a>
                    </div>

                    <!-- Client 5 -->
                    <div class="client-item item">
                        <a href="#"><img src="<?php echo SITE_URL_FIMAGES; ?>/c5.png" alt="" /></a>
                    </div>

                    <!-- Client 6 -->
                    <div class="client-item item">
                        <a href="#"><img src="<?php echo SITE_URL_FIMAGES; ?>/c6.png" alt="" /></a>
                    </div>

                    <!-- Client 7 -->
                    <div class="client-item item">
                        <a href="#"><img src="<?php echo SITE_URL_FIMAGES; ?>/c7.png" alt="" /></a>
                    </div>

                    <!-- Client 8 -->
                    <div class="client-item item">
                        <a href="#"><img src="<?php echo SITE_URL_FIMAGES; ?>/c8.png" alt="" /></a>
                    </div>
